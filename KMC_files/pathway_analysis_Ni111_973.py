...
dir = "C:/Project3_project4/Project4_Potassium_calc_PBE_D3/KMC_results/KMC_results_JCC_2_1/Ni111_calc/MSR_model_973K_10bar_Default/"
...
perc_array_Ni111_973 = np.array([perc_CHOH_CHO_pathway + perc_CHOH_COH_pathway + perc_COH_pathway + perc_CO_pathway, perc_CHO_pathway])

#mylabels = ["others", "CHO-Ni-pathway"]

#plt.subplot(1, 2, 1)  # 1 row, 2 columns, first subplo

#plt.pie(perc_array_Ni111_973, labels = mylabels, startangle = 90)
