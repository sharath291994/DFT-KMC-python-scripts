...
rate_CH4_dissociation_fwd = N_CH4_dissociation_fwd/((NSites)*(tfinal - tss))
                                                        
rate_CH4_dissociation_rev = N_CH4_dissociation_rev/((NSites)*(tfinal - tss))    
...
rate_CH3_dissociation_fwd = N_CH3_dissociation_fwd/((NSites)*(tfinal - tss))
                                                        
rate_CH3_dissociation_rev = N_CH3_dissociation_rev/((NSites)*(tfinal - tss)) 
...
rate_CH2_dissociation_fwd = N_CH2_dissociation_fwd/((NSites)*(tfinal - tss))
                                                        
rate_CH2_dissociation_rev = N_CH2_dissociation_rev/((NSites)*(tfinal - tss))   
...
rate_CH_dissociation_fwd = N_CH_dissociation_fwd/((NSites)*(tfinal - tss))
                                                        
rate_CH_dissociation_rev = N_CH_dissociation_rev/((NSites)*(tfinal - tss))   
...
rate_H2_dissociation_fwd = N_H2_dissociation_fwd/((NSites)*(tfinal - tss))
                                                        
rate_H2_dissociation_rev = N_H2_dissociation_rev/((NSites)*(tfinal - tss))    
...
rate_H2O_adsorption_fwd = N_H2O_adsorption_fwd/((NSites)*(tfinal - tss))
                                                        
rate_H2O_adsorption_rev = N_H2O_adsorption_rev/((NSites)*(tfinal - tss))  
...
rate_H2O_dissociation_fwd = N_H2O_dissociation_fwd/((NSites)*(tfinal - tss))
                                                        
rate_H2O_dissociation_rev = N_H2O_dissociation_rev/((NSites)*(tfinal - tss)) 
...
rate_OH_dissociation_fwd = N_OH_dissociation_fwd/((NSites)*(tfinal - tss))
                                                        
rate_OH_dissociation_rev = N_OH_dissociation_rev/((NSites)*(tfinal - tss))
...
rate_CHOH_formation_fwd = N_CHOH_formation_fwd/((NSites)*(tfinal - tss))
                                                        
rate_CHOH_formation_rev = N_CHOH_formation_rev/((NSites)*(tfinal - tss)) 
...
rate_CHOH_CHO_pathway_fwd = N_CHOH_CHO_pathway_fwd/((NSites)*(tfinal - tss))
                                                        
rate_CHOH_CHO_pathway_rev = N_CHOH_CHO_pathway_rev/((NSites)*(tfinal - tss))        
...
rate_CHOH_COH_pathway_fwd = N_CHOH_COH_pathway_fwd/((NSites)*(tfinal - tss))
                                                        
rate_CHOH_COH_pathway_rev = N_CHOH_COH_pathway_rev/((NSites)*(tfinal - tss)) 
...
rate_CHO_pathway_fwd = N_CHO_pathway_fwd/((NSites)*(tfinal - tss))
                                                         
rate_CHO_pathway_rev = N_CHO_pathway_rev/((NSites)*(tfinal - tss))      
...
rate_CHO_dissociation_fwd = N_CHO_dissociation_fwd/((NSites)*(tfinal - tss))
                                                         
rate_CHO_dissociation_rev = N_CHO_dissociation_rev/((NSites)*(tfinal - tss))      
...
rate_COH_pathway_fwd = N_COH_pathway_fwd/((NSites)*(tfinal - tss))
                                                         
rate_COH_pathway_rev = N_COH_pathway_rev/((NSites)*(tfinal - tss))            
...
rate_COH_dissociation_fwd = N_COH_dissociation_fwd/((NSites)*(tfinal - tss))
                                                         
rate_COH_dissociation_rev = N_COH_dissociation_rev/((NSites)*(tfinal - tss))            
...
rate_CO_pathway_fwd = N_CO_pathway_fwd/((NSites)*(tfinal - tss))
                                                         
rate_CO_pathway_rev = N_CO_pathway_rev/((NSites)*(tfinal - tss)) 
...
rate_CO_adsorption_fwd = N_CO_adsorption_fwd/((NSites)*(tfinal - tss))
                                                         
rate_CO_adsorption_rev = N_CO_adsorption_rev/((NSites)*(tfinal - tss)) 
...
print(f"{net_rate_CO_adsorption:.2e}")

rate_CO2_dissociation_fwd = N_CO2_dissociation_fwd/((NSites)*(tfinal - tss))
                                                         
rate_CO2_dissociation_rev = N_CO2_dissociation_rev/((NSites)*(tfinal - tss)) 
...
print(f"{net_rate_CHOH_CHO_pathway + net_rate_CHOH_COH_pathway + net_rate_CHO_pathway + net_rate_COH_pathway + net_rate_CO_pathway:.2e}")
